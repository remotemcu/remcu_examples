...
/** @addtogroup TIM5_Exported_Types
  * @{
  */

/**
  * @brief TIM5 Forced Action
  */
typedef enum
{
...
/**
  * @brief TIM5 Output Compare and PWM modes
  */
typedef enum
{
...
/**
  * @brief TIM5 Output Compare Polarity
  */
typedef enum
{
...
/**
  * @brief TIM5 Output Compare states
  */
typedef enum
{
...
/**
  * @brief TIM5 Output Compare Idle State
  */
typedef enum
{
...
/**
  * @brief TIM5 Input Capture Polarity
  */
typedef enum
{
...
/**
  * @brief TIM5 Input Capture Selection
  */
typedef enum
{
...
/**
  * @brief TIM5 Input Capture Prescaler
  */
typedef enum
{
...
/**
  * @brief TIM5 TIx External Clock Source
  */
typedef enum
{
...
/**
  * @brief TIM5 Prescaler Reload Mode
  */
typedef enum
{
...
/**
  * @brief TIM5 DMA interrupt sources requests
  */
typedef enum
{
...
/** @addtogroup TIM5_Private_Macros
  * @{
  */
...
/**
  * @brief Macro TIM5 Forced Action
  */
...
/**
  * @brief Macro TIM5 Output Compare and PWM modes
  */
...
/**
  * @brief Macro TIM5 One Pulse Mode
  */
...
/**
  * @brief Macro TIM5 Counter Mode
  */
#define IS_TIM5_COUNTER_MODE(MODE) \
  (((MODE) == TIM5_CounterMode_Up)   || \
...
/**
  * @brief Macro TIM5 Output Compare Polarity
  */
#define IS_TIM5_OC_POLARITY(POLARITY) \
  (((POLARITY) == TIM5_OCPolarity_High) || \
   ((POLARITY) == TIM5_OCPolarity_Low))

/**
  * @brief Macro TIM5 Output Compare states
  */
...
/**
  * @brief Macro TIM5 AOE Bit Set/Reset
  */
...
/**
  * @brief Macro TIM5 OC IDLE STATE
  */
...
/**
  ...
  */
#define IS_TIM5_IC_FILTER(ICFILTER) \
  ((ICFILTER) <= 0x0F)

/**
  * @brief Macro TIM5 Interrupts
  */
...
/**
  * @brief Macro TIM5  TIx external Clock Selection
  */
...
/**
  * @brief Macro TIM5 Prescaler Reload
  */
...
/**
  * @brief Macro TIM5 update source
  */
