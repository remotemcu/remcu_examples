...
/** @defgroup  I2C Acknowledgement position configuration
  * @{
  */
typedef enum
{
...
/**
  * @brief  Macro used by the assert function to check the different I2C SMBus Alert pin configuartion.
  */
 ...
 *          - I2Cx_IRQHandler() which is called when the I2C interurpts occur.
