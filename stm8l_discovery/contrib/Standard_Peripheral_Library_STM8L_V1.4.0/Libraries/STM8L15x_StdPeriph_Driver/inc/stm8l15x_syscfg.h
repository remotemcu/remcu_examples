...
/** @addtogroup SYSCFG_Exported_Types
  * @{
  */

/**
  * @brief Definition of the TIM1 Input Capture to be routed.
  */
typedef enum
{
...
/**
  * @brief Definition of the I/O pin to be assigned to the TIM1 input capture.
  * The values 0x01 and 0x02 are forbidden
  */
typedef enum
{
...
/**
  ...
  * Values are coded in 0xXY format where
  * X: the register index (1: RI_IOSR1, 2: RI_IOSR2 or 3: RI_IOSR3)
...
/**
  * @brief  Definition of DMA channels mapping.
  */
typedef enum
{
...
/** @addtogroup SYSCFG_Private_Macros
  * @{
  */
