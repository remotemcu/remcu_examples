...
typedef enum
{
  RTC_Weekday_Monday      =  ((uint8_t)0x01), /*!< WeekDay Monday*/
  RTC_Weekday_Tuesday     =  ((uint8_t)0x02), /*!< WeekDay Tuesday */
  RTC_Weekday_Wednesday   =  ((uint8_t)0x03), /*!< WeekDay Wednesday*/
  RTC_Weekday_Thursday    =  ((uint8_t)0x04), /*!< WeekDay Thursday*/
  RTC_Weekday_Friday      =  ((uint8_t)0x05), /*!< WeekDay Friday*/
  RTC_Weekday_Saturday    =  ((uint8_t)0x06), /*!< WeekDay Saturday*/
  RTC_Weekday_Sunday      =  ((uint8_t)0x07)  /*!< WeekDay Sunday*/
}
RTC_Weekday_TypeDef;
...
/**
* @brief RTC Sub Seconds Alarm Masks
*/
typedef enum
{
...
typedef enum
{
  RTC_CalibOutput_512Hz  = ((uint8_t)0x00), /*!< RTC Calib Output is 512Hz  */
  RTC_CalibOutput_1Hz    = ((uint8_t)0x80)  /*!< RTC Calib Output is 1Hz     */
}
...
typedef enum
{
  ...
  RTC_FLAG_WUTF    = ((uint16_t)0x0004), /*!< Wake up Timer Flag. If set, the Wake Up downcounter reaches 0 */
...
/**
* @brief RTC Tamper Levels definitions
*/
typedef enum
{
...
/**
* @brief RTC Tamper definitions
*/

typedef enum
{
  RTC_Tamper_1 = ((uint8_t)0x02),  /*!< Tamper 1 */
  RTC_Tamper_2 = ((uint8_t)0x08),  /*!< Tamper 2 */
  RTC_Tamper_3 = ((uint8_t)0x20)   /*!< Tamper 3 */
}
RTC_Tamper_TypeDef;


/**
* @brief RTC Tamper Precharge duractions definitions
*/

typedef enum
{
  RTC_TamperPrechargeDuration_None    = ((uint8_t)0x80),  /*!< Tamper pins are not pre-charged before sampling */
  RTC_TamperPrechargeDuration_1RTCCLK = ((uint8_t)0x00),  /*!< Tamper pins are pre-charged before sampling during 1 RTCCLK cycle  */
  RTC_TamperPrechargeDuration_2RTCCLK = ((uint8_t)0x20),  /*!< Tamper pins are pre-charged before sampling during 2 RTCCLK cycles */
  RTC_TamperPrechargeDuration_4RTCCLK = ((uint8_t)0x40),  /*!< Tamper pins are pre-charged before sampling during 4 RTCCLK cycles */
  RTC_TamperPrechargeDuration_8RTCCLK = ((uint8_t)0x60)   /*!< Tamper pins are pre-charged before sampling during 8 RTCCLK cycles */
}
RTC_TamperPrechargeDuration_TypeDef;


/**
* @brief RTC Tamper Filter definitions
*/
...
/**
* @brief RTC Tamper Sampling Frequencies definitions
*/

typedef enum
{
  RTC_TamperSamplingFreq_RTCCLK_Div32768  = ((uint8_t)0x00), /*!< Each of the tamper inputs are sampled with a freqeuncy =  RTCCLK / 32768 */
  RTC_TamperSamplingFreq_RTCCLK_Div16384  = ((uint8_t)0x01), /*!< Each of the tamper inputs are sampled with a freqeuncy =  RTCCLK / 16384 */
  RTC_TamperSamplingFreq_RTCCLK_Div8192   = ((uint8_t)0x02), /*!< Each of the tamper inputs are sampled with a freqeuncy =  RTCCLK / 8192  */
  RTC_TamperSamplingFreq_RTCCLK_Div4096   = ((uint8_t)0x03), /*!< Each of the tamper inputs are sampled with a freqeuncy =  RTCCLK / 4096  */
  RTC_TamperSamplingFreq_RTCCLK_Div2048   = ((uint8_t)0x04), /*!< Each of the tamper inputs are sampled with a freqeuncy =  RTCCLK / 2048  */
  RTC_TamperSamplingFreq_RTCCLK_Div1024   = ((uint8_t)0x05), /*!< Each of the tamper inputs are sampled with a freqeuncy =  RTCCLK / 1024  */
  RTC_TamperSamplingFreq_RTCCLK_Div512    = ((uint8_t)0x06), /*!< Each of the tamper inputs are sampled with a freqeuncy =  RTCCLK / 512   */
  RTC_TamperSamplingFreq_RTCCLK_Div256    = ((uint8_t)0x07)  /*!< Each of the tamper inputs are sampled with a freqeuncy =  RTCCLK / 256   */
}
RTC_TamperSamplingFreq_TypeDef;


/**
* @brief RTC Add 1 Second parameter definitions
*/
...
/**
* @brief RTC Smooth Calib Period definitions
*/

typedef enum
{
  RTC_SmoothCalibPeriod_32sec  = ((uint8_t)0x00), /*!<  if RTCCLK = 32768 Hz, Smooth calibation period is 32s,  else 2exp20 RTCCLK seconds */
  RTC_SmoothCalibPeriod_16sec  = ((uint8_t)0x20), /*!<  if RTCCLK = 32768 Hz, Smooth calibation period is 16s, else 2exp19 RTCCLK seconds */
  RTC_SmoothCalibPeriod_8sec   = ((uint8_t)0x40)  /*!<  if RTCCLK = 32768 Hz, Smooth calibation period is 8s, else 2exp18 RTCCLK seconds */
}
...
typedef enum
{
  RTC_SmoothCalibPlusPulses_Set    = ((uint8_t)0x80), /*!<  The number of RTCCLK pulses added during a X -second window =  Y  - CALM[8:0].  wth Y = 512, 256, 128 when X = 32, 16, 8 */
  RTC_SmoothCalibPlusPulses_Reset  = ((uint8_t)0x00)  /*!<  The number of RTCCLK pulses subbstited during a 32-second window =   CALM[8:0]. */
...
/**
  * @brief Macro used by the assert_param function in order to check the used Calender Hour format
  */
...
/**
  * @brief Macro used by the assert_param function in order to check the used Calender Hours value (format 12h)
  */
#define IS_RTC_HOUR12_MAX(HOUR) ((HOUR) <= (uint8_t)12)
#define IS_RTC_HOUR12_MIN(HOUR) ((HOUR) > (uint8_t)0)
/**
  * @brief Macro used by the assert_param function in order to check the used Calender Hours value (format 24h)
  */
#define IS_RTC_HOUR24(HOUR) ((HOUR) <= 23)
/**
  * @brief Macro used by the assert_param function in order to check the used Calender minutes value
  */
#define IS_RTC_MINUTES(MINUTES) ((MINUTES) <= 59)
/**
  * @brief Macro used by the assert_param function in order to check the used Calender seconds value
  */
#define IS_RTC_SECONDS(SECONDS) ((SECONDS) <= 59)
/**
  * @brief Macro used by the assert_param function in order to check the used Calender H12 mode
  */
#define IS_RTC_H12(PM) (((PM) == (RTC_H12_AM)) || ((PM) == (RTC_H12_PM)))

/**
  * @brief Macro used by the assert_param function in order to check the used Calender Year value
  */
#define IS_RTC_YEAR(YEAR) ((YEAR) <= 99)
/**
  * @brief Macro used by the assert_param function in order to check the used  Calender month value
  */
#define IS_RTC_MONTH_MAX(MONTH) ((MONTH) <= (uint8_t)12)
#define IS_RTC_MONTH_MIN(MONTH) ((MONTH) >= (uint8_t)1)
/**
  * @brief Macro used by the assert_param function in order to check the used Calender Date value
  */
#define IS_RTC_DATE_MAX(DATE) ((DATE) <= (uint8_t)31)
#define IS_RTC_DATE_MIN(DATE) ((DATE) >= (uint8_t)1)
/**
  * @brief Macro used by the assert_param function in order to check the used Calender Week day value
  */
...
#define IS_RTC_GET_FLAG(FLAG) (((FLAG) == RTC_FLAG_WUTF)   || ((FLAG) == RTC_FLAG_ALRAF) || \
                               ...
                               ((FLAG) == RTC_FLAG_TAMP3F) || ((FLAG) == RTC_FLAG_TAMP2F)|| \
                               ((FLAG) == RTC_FLAG_TAMP1F) || ((FLAG) == RTC_FLAG_SHPF)  || \
                               ((FLAG) == RTC_FLAG_RECALPF) || ((FLAG) == RTC_FLAG_ALRAWF))
/* RTC_FLAG_ALRAWF is for Medium Density only but supported by High Density Devices*/
...
/**
  * @brief Macro used by the assert_param function in order to check the used Tamper Levels
  */
#define IS_RTC_TAMPER_LEVEL(LEVEL) (((LEVEL) == RTC_TamperLevel_Low) ||((LEVEL) == RTC_TamperLevel_High))




/**
  * @brief Macro used by the assert_param function in order to check the used Tamper
  */
#define NOT_CORRECT_TAMPER  (uint8_t)~(uint8_t)(RTC_Tamper_1 |RTC_Tamper_2|RTC_Tamper_3)
#define IS_RTC_TAMPER(TAMPER) (((uint8_t)((TAMPER) & NOT_CORRECT_TAMPER) == RESET) && ((TAMPER) != RESET))

/**
  * @brief Macro used by the assert_param function in order to check the used Tampers Filter
  */
...
/**
  * @brief Macro used by the assert_param function in order to check the used Tampers Sampling Frequencies
  */
...
/**
  * @brief Macro used by the assert_param function in order to check the used Tampers Pins precharge duration
  */
...
/**
  * @brief Macro used by the assert_param function in order to check the used Smooth calib period
  */
...
/**
  * @brief Macro used by the assert_param function in order to check the used Smooth calib Plus pulses
  */
#define  IS_RTC_SMOOTH_CALIB_PLUS(SEL) (((SEL) == RTC_SmoothCalibPlusPulses_Set) || \
                                        ((SEL) == RTC_SmoothCalibPlusPulses_Reset))
/**
  * @brief Macro used by the assert_param function in order to check the used  Smooth calib Minus  pulses
  */
...
/**
  * @brief Macro used by the assert_param function in order to check the used Calib Output Selection
  */
#define  IS_RTC_CALOUTPUT_SELECT(SEL) (((SEL) == RTC_CalibOutput_512Hz) || \
                                       ((SEL) == RTC_CalibOutput_1Hz))
/**
  * @brief Macro used by the assert_param function in order to check the used Alarm subsecond value
  */
#define IS_RTC_ALARM_SS_VALUE(SS) ((SS) <= 0x7FFF)


/**
  * @brief Macro used by the assert_param function in order to check the used Alarm subsecond mask
  */
#define IS_RTC_ALARM_SS_MASK(MASK) ((MASK) <= 0x0F)


/**
  * @brief Macro used by the assert_param function in order to check the used fraction of seconds to sub
  */
#define IS_RTC_SHIFT_SUBFS(FS) ((FS) <= 0x7FFF)

/**
  * @brief Macro used by the assert_param function in order to check the param of 1 second to add
  */
...
/* RTC Shift control  synchonisation function*/
